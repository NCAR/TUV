...
* local:
      ...
      REAL dtabs,dtsct,dscld,dsaer,dssnw,dsany,dacld,daaer,dasnw,daany
      INTEGER i, ii
...
* initialize:
 ...
 5    CONTINUE
      ...
      DO 10 i = 1, nz - 1
         ...
         dsany = dt_any(i,iw)*om_any(i,iw)
         daany = dt_any(i,iw)*(1.-om_any(i,iw))

         dtsct = dtrl(i,iw) + dscld + dsaer + dssnw + dsany
         dtabs = dtso2(i,iw) + dto2(i,iw) + dto3 (i,iw) +
     >           dtno2(i,iw) + dacld + daaer + dasnw + daany
